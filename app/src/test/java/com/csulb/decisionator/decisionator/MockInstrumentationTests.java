...
/**
 * Created by Russell on 4/13/2016.
 */
@RunWith(RobolectricGradleTestRunner.class)
@Config(constants = BuildConfig.class, sdk = 21)
public class MockInstrumentationTests extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        roboContext = shadAct.getApplicationContext();
    ...
    public void test_intentTransition()
    {
        ...
        Intent nextIntent = new Intent(RuntimeEnvironment.application, LobbyActivity.class);
        FacebookLogin uut = new FacebookLogin();
